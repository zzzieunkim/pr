...
<body>
    ...
    <header style="border-bottom: 1px solid rgb(224, 224, 224);">
            ...
            <div class="hdwrap1">
                <div class="ftwrap1"><a href="Mainindex.jsp"><img src="mainindeximgs/logo.png" height="90px"style="padding-left: 20px; margin-top: 20px;"  ></a>
                    ...
                    <div class="topwrap1">
                      <ul>
                        <li>고객센터</li>
                        <li><a href="shopping001_login1.jsp">로그인</a></li>
                        <li><a href="Join_insert1.jsp">회원가입</a></li>
                      </ul>
                    </div>
                  </div> 
          </div>
